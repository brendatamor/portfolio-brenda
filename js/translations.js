...
const translations = {
    ...
    'en': {
        ...
        'pii_client_value': 'CITINOVA, Maurício Bezerra (Project Author) <br> Fortaleza, CE - BRA',
        'pii_services_list': '<li>Requirements Engineering</li><li>UX/UI Design</li><li>Front-end Development</li><li>QA & Security Testing</li>',
        'pii_role_value': 'Product Designer & Front-end Developer',
        'pii_challenge_title': 'The Challenge',
        'pii_challenge_text': 'With the implementation of the LGPD (General Data Protection Law), public servants faced a critical dilemma: how to maintain portals of raw data without unduly exposing SSNs, phone numbers, and addresses? The challenge was technical and operational, as the manual review of millions of records was humanly impossible. My mission was to help conceive a tool that would audit files in various formats (CSV, PDF, XLSX) and deliver an accurate diagnosis to mitigate legal and ethical risks before publication.',
        'pii_deliverables_title': 'Key Deliverables',
        'pii_deliverables_text': 'A robust technical solution was delivered, consisting of: Process Modeling for file scanning, a Search Engine based on Regular Expressions (Regex), a Diagnostic Reporting Interface (Reporting UI), and complete technical documentation for the Open Source ecosystem. The tool allows the administrator to instantly identify in which file and line the sensitive data is located, accelerating the audit cycle by over 100%. Additionally, well-defined UX/UI according to the end-user and a polished design system reduced friction and learning curves.',
        'pii_uxui_title': 'Site Design (UX/UI)',
        'pii_uxui_text': 'The PII CKAN interface design was focused on data visualization and technical clarity. Designing reports for Command Line Tools (CLI) requires a rigorous hierarchy so that the user doesn\'t feel overwhelmed. I used a clean and functional aesthetic, focused on signaling alert and security states. The information architecture was designed to facilitate the sorting of incidents, ensuring that even users with an administrative profile could interpret the technical results of the scan, regardless of their seniority with data.',
        'pii_dev_title': 'Development',
        'pii_dev_text': 'I was responsible for developing the front-end of the first version of the application, focusing on visual fidelity and reading performance. I transformed the raw data processed by the Python engine into a user-friendly report interface. I worked directly on gathering technical requirements with data specialists, ensuring that the front-end correctly consumed the system\'s information and offered a resilient and scalable diagnostic experience for the CKAN environment.',
        'pii_impact_title': 'IMPACT & <br>LEARNINGS',
        'pii_metric_1_title': 'Security and Privacy <br> (LGPD)',
        'pii_metric_1_desc': '<strong>Mitigated Exposure Risk.</strong> The tool ensured a proactive layer of protection, preventing sensitive data (PII) from being inadvertently published. The direct impact was the legal and ethical shielding of the municipality, ensuring that public transparency does not compromise the citizens\' right to privacy according to the LGPD.',
        'pii_metric_2_title': 'Audit Efficiency',
        'pii_metric_2_desc': '<strong>Optimization of the Publication Cycle.</strong> Before PII CKAN, the review of massive datasets was a manual process prone to human error. Automation allowed massive volumes of data to be scanned in minutes, giving back valuable time to servers and accelerating the update of the Open Data portal.',
        'pii_metric_3_title': 'Open Data <br>Quality',
        'pii_metric_3_desc': '<strong>Standardization of Transparency.</strong> The use of the tool raised the maturity level of the data sent by the secretariats. By providing a clear error report, the system educated public servants on the best practices of data handling, resulting in a much more integral and reliable Open Data portal for the population.',
        'pii_metric_4_title': 'Technical Recognition <br> (The Award)',
        'pii_metric_4_desc': '<strong>Seal of Excellence in Innovation.</strong> Winning the 1st place in the Fortaleza in Control Award serves as the ultimate validation metric. The project was audited and awarded by a commission of specialists from USP and UFC, proving its technical effectiveness and its invaluable value for public administration.',
        'pii_metric_5_title': 'The Bridge between Code and LGPD.',
        'pii_metric_5_desc': '<strong>Reducing friction for collaborators.</strong> This project allowed me to understand how to translate complex laws (such as LGPD) into programming logic (Regex and Python). It was my greatest exercise in transposing legal requirements to a simplified technical interface.',
        'pii_metric_6_title': 'Collaboration in Open Source Projects.',
        'pii_metric_6_desc': '<strong>Good documentation is essential.</strong> Participating in an open-source project for the government taught me the importance of creating scalable interfaces and clear documentation, allowing other agencies to replicate the solution with ease.',
        'pii_user_title': 'The User',
        'pii_user_text': 'PII CKAN\'s design was born from the diagnosis of an invisible "bottleneck": <strong>the review of personal data in raw files (CSV, PDF, XLSX).</strong> We present Ricardo, a pragmatic data manager whose productivity is limited by slow and bureaucratic processes. Mapping his journey revealed the critical need for a proactive "safety filter." The project\'s focus was <strong>transforming the fear of human error into a fast, intuitive, and technically robust audit experience</strong>, giving time and institutional security back to the user.',
        'pii_structure_title': 'Project <br> Structure',
        'pii_structure_text': 'To transform a script tool (Python) into an intuitive platform, I designed a structure based on process visibility and auditability. The goal was to ensure that the data manager has full control over security scans, from parameter configuration to the final report verdict.',
        'pii_wireframe_low_title': 'WIREFRAMES',
        'pii_wireframe_low_text': 'For PII CKAN, I used medium-fidelity wireframes to validate the navigation hierarchy before implementation. The focus was to create an <strong>end-to-end audit workflow</strong>. I designed flows where the user could configure a massive scan in a few clicks, selecting specific LGPD patterns (such as SSNs and addresses). The inclusion of a <strong>Reports History (Tasks)</strong> allows the manager to have a retrospective view of data compliance, transforming an exhaustive technical task into an agile, safe, and scalable management process.',
        'pii_ui_title': 'User Interface <br> Design',
        'pii_ui_text': 'PII CKAN\'s visual challenge was to transform a technical audit process into an intuitive and secure experience. For this, I developed a Design System focused on visual semantics, where each color plays a critical role in the manager\'s decision-making.',
        'pii_ui_list': '<li class="project-intro-text mb-4"> <strong>Functional Color Palette: </strong> I used <strong>Teal (#0C87B3)</strong> as the primary color to convey technology and stability. The use of <strong>Red (#FF0000)</strong> and <strong>Green (#057E03)</strong> is strictly functional, instantly signaling files with data leaks (Alert) or compliant datasets (Safe).</li> <li class="project-intro-text mb-4"> <strong>Systemic Typography (Inter): </strong> The choice of the Inter family was strategic. Being a font designed specifically for computer interfaces, it ensures exceptional readability in dense tables, technical logs, and complex reports, reducing user visual fatigue.</li> <li class="project-intro-text mb-4"> <strong>Modular Componentization: </strong> I developed buttons and cards with clear states (Solid and Outline), allowing an <strong>agile and scalable handoff.</strong> This modular structure ensures that the system can grow with new features without losing visual or technical consistency.</li>',
        'pii_wireframe_hi_title': 'High Fidelity <br> Wireframe',
        'pii_wireframe_hi_text_1': 'The high-fidelity stage of PII CKAN was designed to offer maximum transparency about backend processes. Since massive data scans can take time, the interface focus was to keep the user informed through continuous feedback loops: dynamic progress bars, real-time evidence counters, and clear state signaling (Searching, Finished, or Error).',
        'pii_wireframe_hi_text_2': 'I designed the experience to be "error-proof". A critical example is the search cancellation modal, which avoids accidental actions in computationally expensive processes. We transformed technical configuration parameters (such as portal URLs and file directories) into intuitive forms with immediate validation, ensuring that the data manager has full control of the tool without the need for programming knowledge.',
        ...
        // ... Mantenha as traduções de Reciclo, AJDC, Eleveit e JD que você já tem abaixo ...
    },
